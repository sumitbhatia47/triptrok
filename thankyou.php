...
<html>
<head>
<title>Trip Trok | Confirmation </title>
...
<div class="banner-1 ">
	<div class="container">
		<h1 class="wow zoomIn animated animated" data-wow-delay=".5s" style="visibility: visible; animation-delay: 0.5s; animation-name: zoomIn; color: #ADD8E6;">TRIP TROK -Take only memories, leave only footprints</h1>
	</div>
</div>
<!--- /banner-1 ---->
<!--- contact ---->
