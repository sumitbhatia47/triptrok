...
<div class="banner">
	<div class="container">
		<h1 class="wow zoomIn animated animated" data-wow-delay=".5s" style="visibility: visible; animation-delay: 0.5s;
		color: #ADD8E6; animation-name: zoomIn;"> TRIP TROK -Take only memories, leave only footprints</h1>
	</div>
</div>
